...
noremap ,d Added by yourname@yourcompany.com <esc>:r! date<cr>kJ
...
imap <F12> <esc>:FufFile<cr>i
map <S-F12> :FufRenewCache<cr>
imap <S-F12> <esc>:FufRenewCache<cr>
vmap <S-F12> <esc>:FufRenewCache<cr>
...
let g:fuf_infoFile = '~/.vim/tmp/.vimfuzzyfinderinfo'
let g:fuf_abbrevMap = {'^':["**/"]}
let g:fuf_mrufile_maxItem=10
let g:fuf_file_exclude = '\v\~$|\.o$|\.exe$|\.gz$|\.sql$|\.bak$|\.gif$|\.small$|\.ico$|\.big$|\.middle$|\.\d+$|\.png$|\.jpg$|\.swp$|\.cvs$|\.svn|\.cvsignore$|\.tpl\.php$|\.html\.php$|((^|[/\\])\.[/\\]$)'
...
:let Grep_Skip_Files = '*.bak *~ *.gif *.png *.jpg *.sql tags'
...
au  BufRead,BufNewFile  *.txt    set dictionary+=/usr/share/dict/words set spell spelllang=en_us
